...
for seasondir in ['season0']:
    ...
    with open(seasondir + '/teams.json', 'r') as f:
        teams = json.load(f)
    ...
    #########
    # season:
    with open(seasondir + '/season.json', 'r') as f:
        season = json.load(f)
    ...
    if write_season:
        with open(seasondir + '/season.json', 'w') as f:
    ...
    #############
    # postseason:
    with open(seasondir + '/postseason.json', 'r') as f:
    ...
    if write_postseason:
        with open(seasondir + '/postseason.json', 'w') as f:
